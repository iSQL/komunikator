...
const SentenceBar = () => {
  ...
  return (
    <div
      className="flex items-center gap-2 p-2 bg-white border-b-2 border-gray-200 min-h-[256px]"
      role="log"
      aria-live="polite"
      aria-label="Rečenica"
    >
          ...
          >
            <div className="flex-1 min-h-0 w-full flex items-center justify-center overflow-hidden">
              {item.symbolPath.startsWith("data:") ? (
                ...
                <span className="text-7xl leading-none">{item.type === "folder" ? "📁" : "🖼"}</span>
              )}
            </div>
            <span className="text-sm font-semibold text-white drop-shadow-sm text-center leading-tight w-full truncate">
              {item.label}
            </span>
          </div>
        ))}
      ...
      {items.length > 0 && (
        <div className="flex flex-col gap-2 shrink-0 self-stretch justify-center">
          <button
            className="flex items-center justify-center h-[77px] w-[77px] bg-blue-500 text-white rounded-xl hover:bg-blue-600 active:scale-95 transition-all cursor-pointer"
          ...
          <button
            className="flex items-center justify-center h-[77px] w-[77px] bg-gray-200 rounded-xl hover:bg-gray-300 active:scale-95 transition-all cursor-pointer"
            onClick={removeLast}
          ...
          <button
            className="flex items-center justify-center h-[77px] w-[77px] bg-red-200 rounded-xl hover:bg-red-300 active:scale-95 transition-all cursor-pointer"
            onClick={clear}
